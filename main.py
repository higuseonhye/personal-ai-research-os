"""
CLI entrypoint: run the core workflow once (problem → compile → experiment → evaluate → insight → memory).
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Personal AI Research OS — demo pipeline")
